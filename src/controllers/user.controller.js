...
const loginUser = asyncHandler( async(req, res) => {
   ...
   // find the user
   // password check
   // if match generate access token and referesh token
   // send cookie
...
const updateAccountDetails = asyncHandler(async(req, res) => {
  ...
  const user = await User.findByIdAndUpdate(
   ...
   return res.status(200).ApiResponse(200, user, "Account details update successfully")
}) 
...
// UpdateCoverImage code same as updateUserAvatar
export { 
   registerUser, 
   loginUser, 
   logOutUser, 
